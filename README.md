...
# 📖 Morse-Code Ruby <a name="about-project"></a>
...
```sh
  git clone https://github.com/Kanyorok/Morse-code.git
  cd Morse-code
```
...
Feel free to check the [issues page](https://github.com/Kanyorok/Morse-code/issues).
